    ...
    ejabberd_storage:transaction(?HOST,
        fun() ->
            ejabberd_odbc:start([
                ...
                {},
                {"update archive_collection left join archive_jid_prefs as "
                 "full_jid_prefs on archive_collection.with_user = full_jid_prefs.with_user "
                 "and archive_collection.with_server = full_jid_prefs.with_server and "
                 "archive_collection.with_resource = full_jid_prefs.with_resource "
                 "left join archive_jid_prefs as bare_jid_prefs on "
                 "archive_collection.with_user = bare_jid_prefs.with_user and "
                 "archive_collection.with_server = bare_jid_prefs.with_server and "
                 "bare_jid_prefs.with_resource = '' and bare_jid_prefs.exactmatch = 0 "
                 "left join archive_jid_prefs as domain_jid_prefs on "
                 "archive_collection.with_server = domain_jid_prefs.with_server and "
                 "domain_jid_prefs.with_user = '' and domain_jid_prefs.with_resource = '' and "
                 "domain_jid_prefs.exactmatch = 0 left join archive_global_prefs on "
                 "archive_collection.us = archive_global_prefs.us set deleted = 1, "
                 "change_utc = '2004-01-01 00:00:00', version = version + 1 where "
                 "deleted = 0 and not full_jid_prefs.expire is null and "
                 "timestampadd(second, full_jid_prefs.expire, archive_collection.utc) < "
                 "'2004-01-01 00:00:00' or not bare_jid_prefs.expire is null and "
                 "full_jid_prefs.expire is null and timestampadd(second, "
                 "bare_jid_prefs.expire, archive_collection.utc) < '2004-01-01 00:00:00' "
                 "or not domain_jid_prefs.expire is null and full_jid_prefs.expire is null "
                 "and bare_jid_prefs.expire is null and timestampadd(second, "
                 "domain_jid_prefs.expire, archive_collection.utc) < '2004-01-01 00:00:00' "
                 "or not archive_global_prefs.expire is null and domain_jid_prefs.expire is "
                 "null and full_jid_prefs.expire is null and bare_jid_prefs.expire is "
                 "null and timestampadd(second, archive_global_prefs.expire, "
                 "archive_collection.utc) < '2004-01-01 00:00:00'",
                 {updated, 1}},
                {},
                {"update archive_collection left join archive_jid_prefs as "
                 "full_jid_prefs on archive_collection.with_user = full_jid_prefs.with_user "
                 ...
                 "domain_jid_prefs.exactmatch = 0 left join archive_global_prefs on "
                 "archive_collection.us = archive_global_prefs.us set deleted = 1, "
                 "change_utc = '2004-01-01 00:00:01', version = version + 1 where "
                 "deleted = 0 and not full_jid_prefs.expire is null and "
                 "timestampadd(second, full_jid_prefs.expire, archive_collection.utc) < "
                 "'2004-01-01 00:00:01' or not bare_jid_prefs.expire is null and "
                 "full_jid_prefs.expire is null and timestampadd(second, "
                 "bare_jid_prefs.expire, archive_collection.utc) < '2004-01-01 00:00:01' "
                 "or not domain_jid_prefs.expire is null and full_jid_prefs.expire is null "
                 "and bare_jid_prefs.expire is null and timestampadd(second, "
                 "domain_jid_prefs.expire, archive_collection.utc) < '2004-01-01 00:00:01' "
                 "or not archive_global_prefs.expire is null and domain_jid_prefs.expire is "
                 "null and full_jid_prefs.expire is null and bare_jid_prefs.expire is "
                 "null and timestampadd(second, archive_global_prefs.expire, "
                 "archive_collection.utc) < '2004-01-01 00:00:01' "
                 "or archive_global_prefs.expire is null and domain_jid_prefs.expire is "
                 "null and full_jid_prefs.expire is null and bare_jid_prefs.expire is "
                 "null and timestampadd(second, 31536000, archive_collection.utc) < "
                 "'2004-01-01 00:00:01'",
                 {updated, 1}},
