...
CREATE INDEX IDX_archive_colls_with ON archive_collection(us(16),with_user(8),with_server(8),utc);
...
CREATE INDEX IDX_archive_colls_utc ON archive_collection(us(16),utc);
CREATE INDEX IDX_archive_colls_change ON archive_collection(deleted,change_utc);
...
CREATE TABLE archive_message(id INTEGER NOT NULL AUTO_INCREMENT,
                             ...
                             CHARACTER SET utf8
                             COLLATE utf8_general_ci;
CREATE INDEX IDX_archive_msgs_coll_id ON archive_message(coll_id,utc);
